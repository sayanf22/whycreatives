...
export function ThemeToggle() {
    ...
    return (
        <Button
            ...
            size="icon"
            onClick={toggleTheme}
            className="text-foreground hover:bg-black/5 dark:hover:bg-white/10 h-10 w-10 md:h-11 md:w-11 rounded-full flex-shrink-0 relative overflow-hidden transition-colors"
