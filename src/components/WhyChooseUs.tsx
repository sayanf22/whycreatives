...
export const WhyChooseUs = () => {
  ...
  return (
    <section
      ref={ref}
      className={`py-12 sm:py-20 md:py-32 px-5 sm:px-6 bg-background transition-all duration-1000 overflow-x-hidden ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
        }`}
    >
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1 w-full">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 border-l-2 border-border hover:border-foreground transition-colors duration-300">
                <DollarSign className="w-6 h-6 sm:w-8 sm:h-8 mt-1 text-foreground flex-shrink-0" />
                <div>
                  <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-foreground">Unbeatable Value</h3>
                  <p className="text-sm sm:text-base text-muted-foreground">Big savings without compromising on quality or professionalism</p>
                </div>
              </div>
              <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 border-l-2 border-border hover:border-foreground transition-colors duration-300">
                <Zap className="w-6 h-6 sm:w-8 sm:h-8 mt-1 text-foreground flex-shrink-0" />
                <div>
                  <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-foreground">Lightning Fast</h3>
                  <p className="text-sm sm:text-base text-muted-foreground">Quick turnaround times with efficient workflows</p>
                </div>
              </div>
              <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 border-l-2 border-border hover:border-foreground transition-colors duration-300">
                <Shield className="w-6 h-6 sm:w-8 sm:h-8 mt-1 text-foreground flex-shrink-0" />
                <div>
                  <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-foreground">100% Transparent</h3>
                  <p className="text-sm sm:text-base text-muted-foreground">Clear pricing, no hidden fees, regular updates</p>
                </div>
              </div>
              <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 border-l-2 border-border hover:border-foreground transition-colors duration-300">
                <Users className="w-6 h-6 sm:w-8 sm:h-8 mt-1 text-foreground flex-shrink-0" />
                <div>
                  <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-foreground">Dedicated Support</h3>
