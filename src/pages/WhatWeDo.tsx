...
import { Video, Globe, Share2, Megaphone, Instagram, Palette, ArrowRight } from "lucide-react";
  ...
  const timelineData = [
    {
      ...
      content: (
        <div>
          ...
          <Button 
            onClick={() => navigate("/services/video-production")}
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <Button 
            onClick={() => navigate("/services/brand-presence")}
            className="bg-[#b5ff2b] text-black hover:bg-[#9ee024] font-bold px-6 py-3 rounded-full hover:shadow-[0_0_15px_rgba(181,255,43,0.3)] transition-all flex items-center gap-2 group"
          >
            <span>View Service Details & Pricing</span>
            <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <Button 
            onClick={() => navigate("/services/ugc-collaborations")}
            className="bg-[#b5ff2b] text-black hover:bg-[#9ee024] font-bold px-6 py-3 rounded-full hover:shadow-[0_0_15px_rgba(181,255,43,0.3)] transition-all flex items-center gap-2 group"
          >
            <span>View Service Details & Pricing</span>
            <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
