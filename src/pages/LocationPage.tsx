...
import { ArrowRight, Video, Globe, Share2, Megaphone, Sparkles, Palette, Phone, Mail, MapPin, Star, Users, Clock, Shield, CheckCircle2 } from "lucide-react";
...
const services = [
  { icon: Video, name: "Video Editing", desc: "Professional editing, color grading, motion graphics", price: "₹500" },
  { icon: Globe, name: "Web Design", desc: "Modern, responsive, conversion-focused websites", price: "₹2,000" },
  { icon: Share2, name: "Social Media", desc: "Content creation, management, growth strategies", price: "₹3,000/mo" },
  { icon: Megaphone, name: "Digital Marketing", desc: "SEO, PPC, performance marketing campaigns", price: "₹5,000" },
  { icon: Sparkles, name: "Motion Graphics", desc: "Animations, explainers, visual effects", price: "₹1,000" },
  { icon: Palette, name: "Branding", desc: "Logo design, brand identity, guidelines", price: "₹2,500" },
];
...
const LocationPage = () => {
  ...
  const pageTitle = `Best Creative Agency in ${data.name} | Video Editing, Web Design, Digital Marketing - WhyCreatives`;
  const pageDescription = `WhyCreatives is the #1 creative agency in ${data.name}, ${data.state}. Professional video editing from ₹500, web design from ₹2,000, digital marketing & branding. 90% more affordable than local agencies. ${data.description}`;
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="keywords" content={`creative agency ${data.name}, video editing ${data.name}, web design ${data.name}, digital marketing ${data.name}, branding ${data.name}, ${data.state} creative agency, affordable creative services ${data.name}, best agency ${data.name}`} />
      ...
      <main className="pt-28 sm:pt-36">
            ...
            <FadeInWhenVisible>
              <div className="text-center mb-12">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight">
                  ...
                  <br />
                  <span className="text-muted-foreground">in {data.name}</span>
                </h1>
                <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
                  {data.tagline}. {data.description}
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                  <Button size="lg" asChild className="bg-white text-black hover:bg-white/90 font-bold text-lg px-8 py-6">
                    <Link to="/contact">
                      Get Free Quote <ArrowRight className="ml-2 h-5 w-5" />
                    </Link>
                  </Button>
                  <Button size="lg" variant="outline" asChild className="border-white/20 text-lg px-8 py-6">
                    <Link to="/our-work">View Our Work</Link>
                  </Button>
                </div>
                {/* Trust Indicators */}
                <div className="flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
                  <span className="flex items-center gap-2"><Star className="w-4 h-4 text-yellow-500 fill-yellow-500" /> 4.9/5 Rating</span>
                  <span className="flex items-center gap-2"><Users className="w-4 h-4" /> 500+ Projects</span>
                  <span className="flex items-center gap-2"><Clock className="w-4 h-4" /> 24-48hr Delivery</span>
            ...
            <FadeInWhenVisible>
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  Professional creative services at 90% less than {data.name} agencies. Same quality, smarter pricing.
                </p>
              </div>
            </FadeInWhenVisible>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {services.map((service, index) => (
                <FadeInWhenVisible key={index} delay={index * 0.1}>
                  <div className="group p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/[0.08] transition-all duration-300">
                    <div className="flex items-start justify-between mb-4">
                      <div className="p-3 rounded-xl bg-white/10 group-hover:bg-white/20 transition-colors">
                        <service.icon className="w-6 h-6" />
                      </div>
                      <span className="text-sm font-bold text-white/50">from {service.price}</span>
                    </div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              <FadeInWhenVisible delay={0.3}>
                <div>
                  <div className="text-5xl font-black mb-2">48hr</div>
        ...
        <section className="px-4 sm:px-6 py-16 sm:py-24 bg-white/[0.02]">
          <div className="container mx-auto max-w-4xl">
            <FadeInWhenVisible>
              <div className="text-center p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-white/10 to-white/5 border border-white/10">
                <h2 className="text-3xl sm:text-4xl font-black mb-4">
                  Ready to Start Your Project in {data.name}?
                </h2>
                <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Get a free consultation and quote within 2 hours. No commitment, no hidden fees.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center text-sm text-muted-foreground">
                  <a href="tel:+918119811655" className="flex items-center gap-2 hover:text-white transition-colors">
                    <Phone className="w-4 h-4" /> +91 81198 11655
                  </a>
                  <span className="hidden sm:block">•</span>
                  <a href="mailto:hello@whycreatives.in" className="flex items-center gap-2 hover:text-white transition-colors">
